...
// Define the colors with proper names
const Color primaryColor = Color(0xFF0784B5);
const Color Black = Colors.black;
const Color Black57 = Color(0x91000000);
const Color White = Colors.white;
const Color White50 = Color(0x80FFFFFF);
const Color lightSkyBlue = Color(0xFFDCF2F1);
const Color inputFieldColor = Color(0xFFC7DCE4);
