                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: TextField(
                                    decoration: InputDecoration(
                                      contentPadding: const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                                      hintText: phoneHint, // Add phone number hint text here
                                      hintStyle: const TextStyle(
                                        color: greyBlack,
                                        fontSize: 18,
                                        fontFamily: 'boxx',
                                ...
                                const SizedBox(height: 20.0), // Adjusted to make space for the new button position
                              ],
                            ),
                          ),
                        ),
                        const SizedBox(height: 20.0), // Space below the inner rectangle
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
